...
public sealed class LegacyLaneStatusRequestDto
{
...
public sealed class LegacyLaneMessageRequestDto
{
    ...
    public string? Peccancy { get; set; }
...
public sealed class LegacyOverloadWarningRequestDto
{
...
public sealed class LegacyLaneSpecialRequestDto
{
...
public sealed class LegacyTrafficEventPushResponseDto
{
