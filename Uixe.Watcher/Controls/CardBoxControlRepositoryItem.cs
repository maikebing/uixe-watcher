...
namespace Uixe.Watcher.Controls
{
    ...
    internal class CardBoxControlRepositoryItem : RepositoryItem
    {
        ...
        {
            if ((OwnerEdit as CardBoxControl) != null)
                (OwnerEdit as CardBoxControl).UpdateControls();
        ...
        static CardBoxControlRepositoryItem()
        {
            Register();
        }

        public CardBoxControlRepositoryItem()
            : base()
        {
            if (this.ControlType == null)
                this.ControlType = typeof(CardBoxContainer);
        }

        internal const string EditorName = "CardBoxControl";

        public static void Register()
        {
            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(EditorName, typeof(CardBoxControl),
                typeof(CardBoxControlRepositoryItem), typeof(CardBoxControlViewInfo),
                new CardBoxControlPainter(), true, null));
        }
        ...
        {
            base.Assign(item);
            CardBoxControlRepositoryItem rItem = item as CardBoxControlRepositoryItem;
            if (rItem != null)
            {
