...
{
    internal class CardBoxControlPainter : BaseEditPainter
    {
        public CardBoxControlPainter() : base()
        {
        }
        ...
        public override void Draw(ControlGraphicsInfoArgs info)
        {
            ...
            CardBoxControlViewInfo vi = info.ViewInfo as CardBoxControlViewInfo;
            if (vi.Item == null) return;
            CardBoxControlRepositoryItem cri = vi.Item as CardBoxControlRepositoryItem;
