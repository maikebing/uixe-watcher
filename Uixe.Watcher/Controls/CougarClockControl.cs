...
{
    internal class CougarClockControl : BaseEdit, IAutoHeightControl
    {
        ...
        static CougarClockControl()
        {
            CougarClockRepositoryItem.Register();
        }

        public CougarClockControl()
            : base()
        {
            UpdateControls();
        }
        ...
        {
            get { return CougarClockRepositoryItem.EditorName; }
        }

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public new CougarClockRepositoryItem Properties
        {
            get { return base.Properties as CougarClockRepositoryItem; }
        }
