...
{
    internal class CardBoxControlViewInfo : BaseEditViewInfo, IHeightAdaptable
    {
        private CardBoxControlViewInfo(RepositoryItem Item) : base(Item)
        {
        }

        int IHeightAdaptable.CalcHeight(GraphicsCache cache, int width)
        {
            CardBoxControlRepositoryItem cri = Item as CardBoxControlRepositoryItem;
