...
namespace Vnc.Viewer
{
    ...
    {
        protected  ContextMenuStrip   ctxMenu = new ContextMenuStrip();
        private ToolStripMenuItem ctxRotateMenu = new ToolStripMenuItem();
        private ToolStripMenuItem ctxCliScalingMenu = new ToolStripMenuItem();
        private ToolStripMenuItem ctxServScalingMenu = new ToolStripMenuItem();
        private ToolStripMenuItem ctxKeysMenu = new ToolStripMenuItem();
        private ToolStripMenuItem ctxFnMenu = new ToolStripMenuItem();
        ...
        internal ViewFullCf(Conn conn, ConnOpts connOpts, UInt16 width, UInt16 height) : base(conn, connOpts, width, height)
        {
            ...
            connMenu.DropDownItems.Add(item);
            item = new ToolStripMenuItem();
            ...
            item.Text = "-";
            connMenu.DropDownItems.Add(item);
            connMenu.DropDownItems.Add(closeConnItem);

            menu.Items.Add(viewMenu);
            menu.Items.Add(keysMenu);
            ...
            ctxMenu.Items.Add(ctxRotateMenu);
            item = new ToolStripMenuItem();
            item.Text = App.GetStr("Portrait");
            item.Click += rotateHdr;
            ctxRotateMenu.DropDownItems.Add(item);
            item = new ToolStripMenuItem();
            ...
            ctxMenu.Items.Add(ctxCliScalingMenu);
            item = new ToolStripMenuItem();
            item.Text = App.GetStr("None");
            item.Click += cliScalingHdr;
            ctxCliScalingMenu.DropDownItems.Add(item);
            item = new ToolStripMenuItem();
            ...
            ctxMenu.Items.Add(ctxServScalingMenu);
            item = new ToolStripMenuItem();
            item.Text = App.GetStr("None");
            item.Click += servScalingHdr;
            ctxServScalingMenu.DropDownItems.Add(item);
            item = new ToolStripMenuItem();
            ...
            ctxMenu.Items.Add(ctxKeysMenu);
            item = new ToolStripMenuItem();
            item.Text = App.GetStr("Shift down");
            item.Click += keysHdr;
            ctxKeysMenu.DropDownItems.Add(item);
            item = new ToolStripMenuItem();
            ...
            ctxKeysMenu.DropDownItems.Add(ctxFnMenu);
            item = new ToolStripMenuItem();
            item.Text = App.GetStr("F1");
            item.Click += keysHdr;
            ctxFnMenu.DropDownItems.Add(item);
            item = new ToolStripMenuItem();
