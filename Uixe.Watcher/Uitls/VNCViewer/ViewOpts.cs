...
namespace Vnc.Viewer
{
    ...
    public class ViewOpts
    {
        ...
        public PixelSize PixelSize = PixelSize.Force8Bit;
        public bool IsFullScrn = false;
        public Orientation Orientation = Orientation.Portrait;
        public CliScaling CliScaling = CliScaling.None;
        public UInt16 CliScalingWidth = 0;
        public UInt16 CliScalingHeight = 0;
        public ServScaling ServScaling = ServScaling.Default;
        public bool ShareServ = true;
        public bool ViewOnly = false;
        public ScrnUpdAlgo ScrnUpdAlgo = ScrnUpdAlgo.Batch;
        public bool SendMouseLocWhenIdle = false;
        public bool MouseAccelMode = true;
        public MouseSpeed MouseSpeed = MouseSpeed.Normal;
        ...
        public ViewOpts(string fileName)
        {
            Load(fileName);
        }
        ...
        public void AddToXml(XmlDocument doc, XmlElement rootElem)
        {
        ...
        public void ReadFromXml(XmlDocument doc, XmlElement rootElem)
        {
