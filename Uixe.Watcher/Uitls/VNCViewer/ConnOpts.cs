...
namespace Vnc.Viewer
{
    ...
    public class ConnOpts
    {
        ...
        public ConnMode ConnMode = ConnMode.Active;
        public string Host = null;
        public int Port = -1;
        public string Passwd = null;
        public ViewOpts ViewOpts = null;

        public ConnOpts(string host, int port, string passwd, ViewOpts viewOpts)
        {
            if (host == null)
        ...
        public ConnOpts(int port, string passwd, ViewOpts viewOpts)
        {
            // TODO: Check the minimum and maximum values.
            if (port < 0)
                throw new ArgumentException("port", "Not a valid value");
        ...
        public ConnOpts(string fileName)
        {
            Load(fileName);
        }

        public void Save(string fileName, bool savePwd)
        {
