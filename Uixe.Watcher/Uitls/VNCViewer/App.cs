...
"),
        ...
        internal static void NewConn(string fileName)
        {
            ...
            {
                XtraMessageBox.Show(App.GetStr("Unable to open the file!"),
                              App.GetStr("Error"),
                              MessageBoxButtons.OK,
            ...
            {
                XtraMessageBox.Show(App.GetStr("Unable to read from the file!"),
                              App.GetStr("Error"),
                              MessageBoxButtons.OK,
                              MessageBoxIcon.Exclamation,
                              MessageBoxDefaultButton.Button1);
            ...
            {
                XtraMessageBox.Show(App.GetStr("The file is corrupted!"),
                              App.GetStr("Error"),
                              MessageBoxButtons.OK,
                              MessageBoxIcon.Exclamation,
                              MessageBoxDefaultButton.Button1);
        ...
        internal static void NewConn()
        {
            ...
            {
                XtraMessageBox.Show(App.GetStr("Unable to read from the setting file!"),
                              App.GetStr("Error"),
                              MessageBoxButtons.OK,
                              MessageBoxIcon.Exclamation,
                              MessageBoxDefaultButton.Button1);
            ...
            {
                XtraMessageBox.Show(App.GetStr("The setting file is corrupted!"),
                              App.GetStr("Error"),
                              MessageBoxButtons.OK,
                              MessageBoxIcon.Exclamation,
                              MessageBoxDefaultButton.Button1);
        ...
        public static int aMain(string[] args)
        {
            ParseArgs(args);
